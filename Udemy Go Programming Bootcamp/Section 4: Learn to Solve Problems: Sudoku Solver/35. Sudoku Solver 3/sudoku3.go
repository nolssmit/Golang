...
// Receives slice, number to check, row & column and decides if 
// that number fits the rules of the game
...
// 	c. If false find a new value for previous we thought was correct
// 3. Check next column
*/
