...
func TestGetUser(t *testing.T) {
	...
	/*
	   Pointers are used in method reveivers in Go for two main reasons:
	   1. Efficiency: When a large struct is passed by value to a method (i.e. without using a pointer),
	      the entire stuct must be copied, which can be inefficientin terms of memory and performance.
